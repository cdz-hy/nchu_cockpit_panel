...
double pointrationAngle = 248;// 小剑的对应角度
extern int HDGMAG;
...
//	if(graphics[0].x >= compass_x - side / 2 && graphics[0].y >= compass_y - side / 2 && graphics[0].x <= compass_x + side / 2 && graphics[0].y <= compass_y + side / 2){
