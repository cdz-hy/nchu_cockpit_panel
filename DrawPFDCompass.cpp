...
double rotationangle = 0;//罗盘上数字和刻度线旋转的角度
double pointrotationangle = 0;//罗盘指针旋转的角度
int course = 60;//罗盘指定的航向

//画罗盘的框架
void draw_frame(double compass_x, double compass_y, double side)
{
...
//画旋转的文字
void draw_text(double compass_x, double compass_y, double side)
{
	double compass_r = side * 30.5 / 96;//罗盘的半径
...
{
	draw_frame(compass_x, compass_y, side);
	...
	draw_text(compass_x, compass_y, side);
